...
def sample_function(user_train, usernum, itemnum, batch_size, maxlen, result_queue, SEED):
    def sample():
        ...
        # print(pos, pos_revs)
        # input('check data')
        return (user, seq, pos, neg, seq_revs, pos_revs) #len(seq)=len(pos)=len(neg), pos means the label of seq[1:], neg means the items not existing in seq
